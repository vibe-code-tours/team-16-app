    ...
    <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-white">
      <header className="border-b border-purple-100 bg-white/90">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          <Link
            to="/"
            className="flex items-center gap-2 rounded-lg text-xl font-bold text-gray-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2"
          ...
          <nav aria-label="Public navigation" className="flex items-center gap-2">
            <Link
              to="/login"
              className="rounded-lg px-3 py-2 text-sm font-semibold text-gray-600 transition-colors duration-200 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2"
            >
              Sign in
            </Link>
            <Link
      ...
      <main>
        <section className="learning-hero-enter mx-auto grid max-w-6xl gap-10 px-4 py-12 md:grid-cols-[minmax(0,1.1fr)_minmax(300px,0.9fr)] md:items-center md:py-16">
          <div>
            <Badge className="mb-4 bg-purple-100 text-purple-700">IT Exam Prep — Gamified</Badge>
            <h1 className="max-w-3xl text-5xl font-bold text-gray-900 sm:text-6xl">
              NerdQuiz
            </h1>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              ...
              <Link
                to="/login"
                className="inline-flex min-h-12 items-center justify-center rounded-lg border-2 border-gray-300 px-8 py-3 text-base font-semibold text-gray-700 transition-colors duration-200 hover:bg-gray-50 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-500 focus-visible:ring-offset-2"
              >
          ...
          <Card className="border-purple-100 bg-white/90" padding="lg">
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                <span
                  className="learning-owl-enter flex size-20 shrink-0 items-center justify-center rounded-3xl bg-purple-50 text-5xl shadow-sm ring-1 ring-purple-100"
                  aria-hidden="true"
                >
                  🦉
                </span>
        ...
        <section aria-labelledby="features-heading" className="mx-auto max-w-6xl px-4 pb-16">
          <div className="mb-6 max-w-2xl">
            <Badge className="mb-2 bg-amber-100 text-amber-700">Complete learning loop</Badge>
                ...
                <Card className={`h-full border-t-4 ${feature.accentClass} transition-all duration-200 group-hover:-translate-y-1 group-hover:shadow-md`} padding="lg">
                  <div className="flex h-full flex-col gap-4">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className="text-gray-400 transition-transform duration-200 group-hover:translate-x-1 group-hover:text-purple-600" aria-hidden="true">
                        →
                      </span>
                    </div>
                    ...
                    <p className="text-sm font-semibold text-purple-700">{feature.action}</p>
                  </div>
                </Card>
              </Link>
            ))}
