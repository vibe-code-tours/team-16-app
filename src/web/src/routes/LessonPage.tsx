  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gray-50 dark:bg-gray-900">
      <header className="border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800">
        <div className="mx-auto flex max-w-4xl items-center justify-between gap-4 px-4 py-4 overflow-hidden">
          <button
            onClick={() => navigate(`/map/${lesson.topic_id}`)}
            className="text-purple-600 hover:text-purple-800 flex items-center gap-2 font-medium shrink-0"
          >
          ...
          <h1 className="text-xl font-bold text-gray-900 dark:text-gray-100 min-w-0 truncate">{lesson.title}</h1>
        </div>
      </header>
