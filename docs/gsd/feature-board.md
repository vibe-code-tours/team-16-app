...
| 20 | Backend Dockerization | | Not started | Multi-stage Dockerfile (Gradle + JRE 21), docker-compose.yml orchestrating backend + Supabase local. [Issue #12](https://github.com/vibe-code-tours/team-16-app/issues/12) |
